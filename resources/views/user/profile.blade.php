                    ...
                    <div class="card-body">
                        <div class="text-center mb-5">
                            <div class="avatar avatar-xxl avatar-circle mb-5">
                                ...
                                <img src="https://d33wubrfki0l68.cloudfront.net/053f2dfd0df2f52c41e903a21d177b0b44abc9b1/1282c/assets/images/profiles/profile-06.jpeg"
                    ...
                    <ul class="scrollspy mb-5" id="account" data-scrollspy="{&quot;offset&quot;: &quot;30&quot;}">
                        ...
                        <li>
                            <a href="#usernameSection" class="d-flex align-items-center py-3">
                                <svg viewBox="0 0 24 24" height="14" width="14" class="me-3"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M17.25,12A5.25,5.25,0,1,1,12,6.75,5.25,5.25,0,0,1,17.25,12Z" fill="none"
                                        stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="1.5"></path>
                                    <path d="M17.25,12v2.25a3,3,0,0,0,6,0V12a11.249,11.249,0,1,0-4.5,9" fill="none"
                                        stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="1.5"></path>
                                </svg>
                                Username
                            ...
                            <a href="#connectedAccountsSection" class="d-flex align-items-center py-3">
                                <svg viewBox="0 0 24 24" height="14" width="14" class="me-3"
                                    ...
                                    <path
                                        ...
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="1.5"></path>
                                    <path d="M1.500 5.248 A2.250 2.250 0 1 0 6.000 5.248 A2.250 2.250 0 1 0 1.500 5.248 Z"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="1.5"></path>
                                    <path d="M16.151 7.848L19.411 4.588" fill="none" stroke="currentColor"
                                        stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                    <path d="M16.794 12.292L19.079 14.577" fill="none" stroke="currentColor"
                                        stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                    <path d="M13.5 14.248L13.5 18.748" fill="none" stroke="currentColor"
                                        stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                    <path d="M10.851 13.147L4.59 19.408" fill="none" stroke="currentColor"
                                        stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                    <path d="M10.001 9.149L5.61 6.514" fill="none" stroke="currentColor"
                                        stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                </svg>
                                Connected accounts
                            </a>
                ...
                <form novalidate="">
                    ...
                    <div class="card border-0 scroll-mt-3" id="basicInformationSection">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-4">
                                <div class="col-lg-3">
                                    <label for="country-ts-control" class="col-form-label"
                                        id="country-ts-label">Location</label>
                                </div>

                                <div class="col-lg">
                                    <div class="mb-4">
                                        <select class="form-select tomselected ts-hidden-accessible" id="country"
                                        ...
                                        <div class="ts-wrapper form-select single input-hidden required full has-items">
                                            <div class="ts-control"><span class="d-flex align-items-center item"
                                                    data-value="us" data-ts-item=""><span
                                                        class="avatar avatar-circle avatar-xxs"><img
                                                            class="avatar-img shadow-sm"
                                                            src="./assets/images/flags/1x1/us.svg"></span><span
                                                        class="text-truncate ms-2">United States of
                                                        America</span></span><input type="select-one" autocomplete="off"
                                                    size="1" tabindex="0" role="combobox"
                                                    aria-haspopup="listbox" aria-expanded="false"
                                                    aria-controls="country-ts-dropdown" id="country-ts-control"
                                                    aria-labelledby="country-ts-label" placeholder="Country"></div>
                                            <div class="ts-dropdown single" style="display: none;">
                                                <div role="listbox" tabindex="-1" class="ts-dropdown-content"
                                                    id="country-ts-dropdown" aria-labelledby="country-ts-label"></div>
                                            </div>
                                        </div>
                    ...
                    <div class="card border-0 scroll-mt-3" id="usernameSection">
                        ...
                        <div class="card-body">
                            <p class="small text-muted mb-3">Your current username is <strong>@ellietucker</strong></p>
                                ...
                                <div class="col-lg">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="username" placeholder="username"
                                            value="ellietucker" aria-describedby="username-addon">
                                    </div>
                                ...
                                <div class="col-lg">
                                    <div class="input-group input-group-merge">
                                        <input type="password" class="form-control" id="newPassword" autocomplete="off"
                                            data-toggle-password-input="" placeholder="Your new password">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-3 h-15px">
                                        <div class="progress d-flex flex-grow-1 h-7px">
                                            <div data-zxcvbn="{&quot;input&quot;: &quot;#newPassword&quot;, &quot;text&quot;: &quot;#progressText&quot;}"
                                                class="progress-bar" role="progressbar" aria-valuemin="0"
                                                aria-valuemax="100" style="width: 0%;"></div>
                                        </div>
                                        <span class="text-muted fs-6" id="progressText" style="margin-left: 0px;"></span>
                                    </div>
                                </div>
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <div class="me-2">
                                        ...
                                        <p class="small text-muted mb-0">Nunc eget libero posuere, cursus mi tincidunt,
                                            mattis nisi</p>
                                    </div>
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <div class="d-flex align-items-center">
                                        <svg width="40" height="14" viewBox="0 0 81 27" version="1.1"
                                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                            <title>visa</title>
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <g transform="translate(-87.000000, -72.000000)">
                                                    <g id="visa" transform="translate(75.000000, 50.000000)">
                                                        <rect id="Rectangle-26" fill-opacity="0" fill="#FFFFFF" x="0"
                                                            y="0" width="110" height="70"></rect>
                                                        <g transform="translate(12.000000, 21.000000)" id="g4155-Clipped"
                                                            fill-rule="nonzero" fill="#1A1F71">
                                                            <g
                                                                transform="translate(41.000000, 14.345679) scale(1, -1) translate(-41.000000, -14.345679) translate(0.000000, 0.345679)">
                                                                <g id="g4155">
                                                                    <g id="g4161"
                                                                        transform="translate(0.054676, 0.096245)">
                                                                        <path
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="dropdown">
                                            <a href="javascript: void(0);"
                                                class="dropdown-toggle no-arrow d-flex mx-2 text-secondary" role="button"
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <div class="d-flex align-items-center">
                                        <svg width="40" height="31" viewBox="0 0 72 56" version="1.1"
                                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                            <title>mastercard</title>
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <g transform="translate(-94.000000, -152.000000)">
                                                    <g id="mastercard" transform="translate(75.000000, 145.000000)">
                                                        <rect id="Rectangle-26-Copy" fill-opacity="0" fill="#FFFFFF"
                                                            x="0" y="0" width="110" height="70"></rect>
                                                        <g id="Group" transform="translate(19.000000, 7.000000)"
                                                            ...
                                                            <g id="XMLID_328_">
                                                                <rect id="Rectangle-path" fill="#FF5F00" x="26.359322"
                                                                    y="5.23478261" width="19.220339" height="34.4521739">
                                                                </rect>
                                                                <path
                    ...
                    <div class="card border-0 scroll-mt-3" id="notificationsSection">
                        ...
                        <div class="card-body">
                            <p class="text-muted">In this setcion you will be able to configure the behaviour of
                                notifications in Dashly</p>
                            ...
                            <div class="table-responsive">
                                <table id="notificationsTable" class="table align-middle">
                                    <thead class="thead-light">
                                        <tr>
                                            <th class="text-uppercase py-4 align-middle min-w-300px min-w-md-auto">Type
                                            </th>
                                            <th class="text-center text-uppercase py-4">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                    height="24" width="24" class="d-block mx-auto mb-1">
                                                    <g>
                                                        <g>
                                                            <path d="M13.5,13a4.38,4.38,0,0,1-1.5.26,4.5,4.5,0,1,1,4.5-4.5"
                                                                style="fill: none;stroke: currentColor;stroke-linecap: round;stroke-linejoin: round;stroke-width: 1.5px">
                                                            </path>
                                                            <circle cx="12" cy="8.75" r="1.5"
                                                                style="fill: none;stroke: currentColor;stroke-linecap: round;stroke-linejoin: round;stroke-width: 1.5px">
                                                            </circle>
                                                            <path d="M13.5,8.75a1.5,1.5,0,0,0,3,0"
                                                                style="fill: none;stroke: currentColor;stroke-linecap: round;stroke-linejoin: round;stroke-width: 1.5px">
                                                            </path>
                                                        </g>
                                                        <g>
                                                            <path
                                                                d="M20.25,12.75V2.25a1.5,1.5,0,0,0-1.5-1.5H5.25a1.5,1.5,0,0,0-1.5,1.5v10.5"
                                                                style="fill: none;stroke: currentColor;stroke-linecap: round;stroke-linejoin: round;stroke-width: 1.5px">
                                                            </path>
                                                            <path
                                                                d="M22,11.46a.77.77,0,0,1,.8-.08.73.73,0,0,1,.42.67v9.7a1.5,1.5,0,0,1-1.5,1.5H2.25a1.5,1.5,0,0,1-1.5-1.5v-9.7a.73.73,0,0,1,.42-.67.77.77,0,0,1,.8.08l8.18,5.9a3,3,0,0,0,3.7,0Z"
                                                                style="fill: none;stroke: currentColor;stroke-linecap: round;stroke-linejoin: round;stroke-width: 1.5px">
                                                            </path>
                                                        </g>
                                                    </g>
                                            ...
                                            <th class="text-center text-uppercase py-4">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                    ...
                                                    <rect class="a" x="0.75" y="0.75" width="22.5" height="9.5"
                                                        rx="1"></rect>
                                                    <line class="a" x1="0.75" y1="3.75" x2="23.25"
                                                        y2="3.75"></line>
                                                    <rect class="a" x="0.75" y="13.75" width="22.5" height="9.5"
                                                        rx="1"></rect>
                                                    <line class="a" x1="0.75" y1="16.75" x2="23.25"
                                                        y2="16.75"></line>
                                                </svg>
                                                Browser
                                            </th>
                                            <th class="text-center text-uppercase py-4">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                    ...
                                                    <rect class="a" x="3.876" y="5.75" width="11.5" height="3.5"
                                                        rx="0.5"></rect>
                                                    <rect class="a" x="5.374" y="12" width="11.5" height="3.5"
                                                        rx="0.5"></rect>
                                                    <line class="a" x1="18.374" y1="5.75"
                                                        x2="21.374" y2="5.75"></line>
                                                    <line class="a" x1="19.124" y1="10.75"
                                                        x2="22.124" y2="10.75"></line>
                                                    <line class="a" x1="20.124" y1="15.5"
                                                        x2="23.124" y2="15.5"></line>
                                                    <path class="a"
                                                        d="M14.376,18.75v2a2.5,2.5,0,0,1-2.5,2.5h-8.5a2.5,2.5,0,0,1-2.5-2.5V3.25a2.5,2.5,0,0,1,2.5-2.5h8.5a2.5,2.5,0,0,1,2.487,2.244">
                                                    </path>
                                                    <line class="a" x1="0.876" y1="18.75"
                                                        x2="14.376" y2="18.75"></line>
                                                </svg>
                                                App
                                            </th>
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <p class="small text-muted mb-0">Nunc suscipit est quis tincidunt lobortis
                                                </p>
                                            </td>
                                            <td class="text-center">
                                                <div class="form-check form-check-inline m-0">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <p class="small text-muted mb-0">Nunc eget libero posuere, cursus mi
                                                    tincidunt, mattis nisi</p>
                                            </td>
                                            <td class="text-center">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input" type="checkbox" checked="">
                                            ...
                                            <td>
                                                <h3 class="h4 mb-0">
                                                    ...
                                                    <a href="javascript: void(0);" data-bs-toggle="tooltip"
                                                        ...
                                                        aria-label="Maecenas sit amet lectus et orci facilisis venenatis"
                                                        data-bs-original-title="Maecenas sit amet lectus et orci facilisis venenatis">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                            height="14" width="14">
                                                            <path
                                                ...
                                                <p class="small text-muted mb-0">In dapibus magna ac tellus lacinia,
                                                    tempus pretium mauris scelerisque</p>
                                            </td>
                                            <td class="text-center">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input" type="checkbox" checked="">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <p class="small text-muted mb-0">Ut viverra sapien ut purus ultricies, et
                                                    euismod enim viverra</p>
                                            </td>
                                            <td class="text-center">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input" type="checkbox">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    ...
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input" type="checkbox" role="switch"
                                            checked="" id="connectGoogle">
                                    </div>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <div class="d-flex align-items-center">
                                        <svg width="32" height="32" viewBox="0 0 256 249"
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <p class="small text-muted mb-0">Vestibulum egestas erat nec nisl commodo
                                                egestas</p>
                                        </div>
                                    </div>
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input" type="checkbox" role="switch"
                                            checked="" id="connectGithub">
                                    </div>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <div class="d-flex align-items-center">
                                        <svg height="32" viewBox="2.59 0 214.09101008 224" width="32"
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink">
                                            <linearGradient gradientTransform="matrix(1 0 0 -1 0 264)"
                                                gradientUnits="userSpaceOnUse" x1="102.4" x2="56.15"
                                                y1="218.63" y2="172.39">
                                                <stop offset=".18" stop-color="#0052cc"></stop>
                                                <stop offset="1" stop-color="#2684ff"></stop>
                                            </linearGradient>
                                            <linearGradient x1="114.65" x2="160.81" xlink:href="#a"
                                                y1="85.77" y2="131.92"></linearGradient>
                                            <path
                                                ...
                                                fill="#2684ff"></path>
                                            <path d="m108.33 78.88a55.75 55.75 0 0 1 -.24-78.61l-72.47 72.44 39.44 39.44z"
                                                fill="url(#a)"></path>
                                            <path d="m141.53 111.91-33.2 33.21a55.77 55.77 0 0 1 0 78.86l72.67-72.63z"
                                                fill="url(#b)"></path>
                                        </svg>
                                        <div class="ms-3">
                                            <h3 class="h4 mb-0">JIRA</h3>
                                            <p class="small text-muted mb-0">Maecenas sit amet nibh iaculis, <a
                                                    href="javascript: void(0);">commodo</a></p>
                                        </div>
                                    </div>
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input" type="checkbox" role="switch"
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <div class="d-flex align-items-center">
                                        <svg height="32" viewBox="-.1 1.1 304.9 179.8" width="32"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <p class="small text-muted mb-0">Lorem ipsum dolor sit amet, consectetur
                                                adipiscing elit</p>
                                        </div>
                                    </div>
                                    <div class="form-check form-switch mb-0">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <div class="d-flex align-items-center">
                                        <svg height="30" preserveAspectRatio="xMidYMid" width="30"
                                            ...
                                            <linearGradient x1="108.633%" x2="46.927%" y1="13.818%"
                                                y2="78.776%">
                                                <stop offset=".18" stop-color="#0052cc"></stop>
                                                <stop offset="1" stop-color="#2684ff"></stop>
                                            </linearGradient>
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <p class="small text-muted mb-0">Fusce at sem viverra, scelerisque justo ac,
                                                dapibus libero</p>
                                        </div>
                                    </div>
                                    <div class="form-check form-switch mb-0">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <div class="d-flex align-items-center">
                                        <svg width="30" height="30" enable-background="new 0 0 2447.6 2452.5"
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <p class="small text-muted mb-0">Sed dapibus sapien <a
                                                    href="javascript: void(0);">vel bibendum</a> egestas</p>
                                        </div>
                                    </div>
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input" type="checkbox" role="switch"
                                            checked="" id="connectSlack">
                                    </div>
                                </li>
                            </ul>
